...
INSERT INTO students (id, course, group_number, is_captain, has_team, about_self, contacts, current_team_id, user_id, current_track_id) VALUES (23, 1, 1, false, true, 'Системный администратор с опытом настройки и поддержки Linux-серверов', 'tg', 5, 25, 1);
