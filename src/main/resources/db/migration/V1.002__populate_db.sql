...
VALUES
    (1, 1, 1, false, false, 'Изучаю веб-разработку и интересуюсь UX/UI дизайно', 'whatsapp', NULL, 2,1),
    (2, 1, 1, true, true, 'Фанат Python и люблю автоматизировать рутинные задачи', 'ok', 1, 3,1),
    (3, 1, 1, true, true, 'Занимаюсь кибербезопасностью и стремлюсь защитить данные пользователей', 'tg', 2, 4,1),
    (4, 1, 1, false, true, 'Изучаю машинное обучение и мечтаю работать в AI-стартапе', 'tg', 2, 5,1),
    (5, 1, 1, false, false, 'Люблю исследовать базы данных и оптимизировать их производительность', 'teams', NULL, 6,2),
    ...
    (8, 5, 1, false, true, 'Увлекаюсь интернет-маркетингом и знаю, как продвигать проекты онлайн', 'teams', 3, 10,2),
    (9, 1, 1, false, false, 'Программист и люблю работать с открытым кодом', 'vk', NULL, 8,2),
    (10, 1, 1, true, true, 'Изучаю DevOps и хочу улучшить процессы разработки и развертывания', 'ok', 4, 9,2),
    (11, 2, 1, false, false, 'Мечтаю создавать видеоигры', 'vk', NULL, 14,2),
    (12, 2, 1, false, true, 'Изучаю компьютерную графику и работаю над проектами анимации', 'tg', 1, 13,3),
    (13, 2, 1, false, false, 'Увлекаюсь блокчейн-технологиями и криптовалютами', 'tg', NULL, 12,2),
    (14, 5, 1, false, true, 'Люблю разрабатывать чат-ботов и создавать умные решения', 'tg', 3, 11,1),
    (15, 5, 1, false, true, 'Программирую на Java и интересуюсь разработкой корпоративных приложений', 'tg', 3, 16,1),
    (16, 5, 1, false, true, 'Изучаю философию технологий и их влияние на общество', 'tg', 3, 15,1),
    (17, 5, 1, true, true, 'Изучаю кроссплатформенную разработку и создаю приложения для всех устройств', 'teams', 3, 19,1),
    (18, 5, 1, false, false, 'Исследую машинное зрение и работаю с проектами на основе нейросетей', 'ok', NULL, 17,1),
    (19, 2, 1, false, true, 'Увлекаюсь тестированием ПО и стремлюсь к качеству в каждом проекте', 'ok', 4, 18,1)
ON CONFLICT DO NOTHING;
