...
VALUES
    ...
    (10, 1, 1, true, true, 'Изучаю DevOps и хочу улучшить процессы разработки и развертывания', 'ok', 4, 9, 1),
    ...
    (14, 5, 1, false, true, 'Люблю разрабатывать чат-ботов и создавать умные решения', 'tg', 3, 11, 2),
    (15, 5, 1, false, true, 'Программирую на Java и интересуюсь разработкой корпоративных приложений', 'tg', 3, 16, 2),
    (16, 5, 1, false, true, 'Изучаю философию технологий и их влияние на общество', 'tg', 3, 15, 2),
    (17, 5, 1, true, true, 'Изучаю кроссплатформенную разработку и создаю приложения для всех устройств', 'teams', 3, 19, 2),
    (18, 5, 1, false, false, 'Исследую машинное зрение и работаю с проектами на основе нейросетей', 'ok', NULL, 17, 2),
