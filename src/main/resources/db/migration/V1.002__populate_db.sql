...
VALUES
    ...
    (7, 1, 1, false, false, 'Изучаю системы управления контентом и создаю собственные сайты', 'whatsapp', NULL, 1),
    ...
    (3, 1, 1, false, true, 'Занимаюсь кибербезопасностью и стремлюсь защитить данные пользователей', 'tg', 2, 4),
    (4, 1, 1, true, true, 'Изучаю машинное обучение и мечтаю работать в AI-стартапе', 'tg', 2, 5),
    ...
    (12, 2, 1, true, true, 'Изучаю компьютерную графику и работаю над проектами анимации', 'tg', 1, 13),
    (14, 5, 1, false, false, 'Люблю разрабатывать чат-ботов и создавать умные решения', 'tg', 3, 11),
    (15, 5, 1, false, false, 'Программирую на Java и интересуюсь разработкой корпоративных приложений', 'tg', 3, 16),
    (16, 5, 1, false, false, 'Изучаю философию технологий и их влияние на общество', 'tg', 3, 15),
    (17, 5, 1, true, true, 'Изучаю кроссплатформенную разработку и создаю приложения для всех устройств', 'teams', NULL, 19),
...
VALUES
    ...
    (2, 3, false, 'Byte Busters', 'Наша команда разрабатывает мобильное приложение для отслеживания здоровья и фитнеса', 'Mobile application', 2, 1, '2024-11-20 18:28:15.047117', '2024-11-20 18:28:15.047117'),
    (3, 8, false, 'Innovators United', 'Мы разрабатываем платформу для онлайн-обучения, которая адаптируется под нужды пользователя.', 'Cross-platform application', 4, 3, '2024-11-21 20:24:36.402366', '2024-11-21 20:24:36.402366'),
